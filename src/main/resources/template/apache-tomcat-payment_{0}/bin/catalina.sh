...
ulimit -n 10240
ulimit -c unlimited
export JAVA_OPTS="$JAVA_OPTS -Dfile.encoding=UTF8 -Dsun.jnu.encoding=UTF8"
CATALINA_OPTS="$CATALINA_OPTS -server -Xmx1024M -Xms256M -Xss256k -XX:MaxPermSize=256M -XX:+HeapDumpOnOutOfMemoryError -Djava.awt.headless=true"
